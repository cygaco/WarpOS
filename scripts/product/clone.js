...
/**
 * scripts/product/clone.js — thin re-export shim (T-20260521-177).
 *
 * Canonical implementation moved to scripts/portfolio/clone.js as part of the
 ...
 * deprecation banner. After that, the /product:clone skill is removed and
 * this shim goes with it.
 *
 * Contract preserved:
 *   - `require('scripts/product/clone')` returns the same object as
 *     `require('scripts/portfolio/clone')`.
 *   - `node scripts/product/clone.js --help` (and any other CLI invocation)
 *     prints the same help and behaves identically to running the canonical
 *     script directly (AC-10.2).
 */

const target = require("../portfolio/clone");
...
if (require.main === module) {
  ...
  const canonical = path.resolve(__dirname, "..", "portfolio", "clone.js");
