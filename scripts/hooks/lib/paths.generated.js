...
const PATHS = {
  ...
  "betaSystem": path.join(PROJECT, ".claude", "agents", "president", ".system", "beta"),
  "policy": path.join(PROJECT, ".claude", "agents", "president", ".system", "policy"),
  "decisionPolicy": path.join(PROJECT, ".claude", "agents", "president", ".system", "policy", "decision-policy.md"),
  "currentStage": path.join(PROJECT, ".claude", "agents", "president", ".system", "policy", "current-stage.md"),
  "adrIndex": path.join(PROJECT, ".claude", "agents", "president", ".system", "policy", "adr", "INDEX.md"),
  ...
  "oneshotStore": path.join(PROJECT, ".claude", "agents", "president", ".system", "oneshot", "store.json"),
  "oneshotSystem": path.join(PROJECT, ".claude", "agents", "president", ".system", "oneshot"),
  "oneshotRetros": path.join(PROJECT, ".claude", "agents", "president", ".system", "oneshot", "retros"),
  ...
  "judgmentModel": path.join(PROJECT, ".claude", "agents", "president", ".system", "beta", "judgement-model.md"),
  "judgmentRecommendations": path.join(PROJECT, ".claude", "agents", "president", ".system", "beta", "judgement-model-recommendations.md"),
  "betaSourceData": path.join(PROJECT, ".claude", "agents", "president", ".system", "beta", "beta-source-data.md"),
  "betaEvents": path.join(PROJECT, ".claude", "agents", "president", ".system", "beta", "events.jsonl"),
  "lexicon": path.join(PROJECT, ".claude", "agents", "president", ".system", "lexicon.md"),
  ...
  "providerFallbackPolicy": path.join(PROJECT, ".claude", "agents", "president", ".system", "policy", "provider-fallback.json"),
  ...
  "sprintFullAutonomy": path.join(PROJECT, ".claude", "agents", "president", ".system", "policy", "sprint-full-autonomy.json"),
  ...
  "sprintRouting": path.join(PROJECT, ".claude", "agents", "president", ".system", "policy", "sprint-routing.json"),
  ...
  "providerFailureModes": path.join(PROJECT, ".claude", "agents", "president", ".system", "policy", "provider-failure-modes.json"),
