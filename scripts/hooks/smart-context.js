...
async function main() {
  ...
  // (The Phase-0 Gemini auth-source-mismatch notice was removed in the 2026-07-20
  // deep-clean along with the SUNSET individual `gemini` CLI it warned about; the
  // supported agy lane self-auths via its own keyring.)
