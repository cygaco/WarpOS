...
Wired into the SP-20260522-001 architecture core alongside `/check:warpos-manifest-coverage` (planned), `/check:framework-purity`, and the canonical pre-commit guard. See `_warpos/MANIFEST.json` for the source-of-truth.
