...
# /check:warpos-manifest-coverage
...
Schema: `schemas/warpos-manifest.schema.json` (v1). Generator: `scripts/warpos/manifest/build.js`. See also: `/check:framework-views-fresh`, `/check:framework-purity`.
