...
Then read `.claude/agents/president/delta.md` and execute its startup procedure. Begin from wherever `store.json` indicates (`heartbeat.status`, `runLog`, current phase).
