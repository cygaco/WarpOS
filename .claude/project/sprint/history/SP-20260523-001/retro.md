# Sprint Retrospective — Fix current.yaml#status + active-sprints.yaml status lag after /sprint:full Phase 5

**Sprint:** `SP-20260523-001`
**Plan Contract:** `PC-20260523-0030`
**Synthesis mode:** `skeleton`
**Synthesized at:** `2026-05-23T03:58:52.236Z`
**Signed off by:** `alpha` at `2026-05-23T03:58:52.236Z`
...
- Predicted confidence: `<unknown — no evidence in tracker>`
...
- Retro written at: `2026-05-23T03:58:52.236Z`
- Synthesis: `skeleton` (n/a)
- History record: `(no sprint-history.yaml)`
- Release record: `RL-20260523-025`

> Re-run with `/sprint:retrospective --sprint SP-20260523-001 --force` to regenerate this retro from updated tracker state, or `--review-only` to print without regenerating.
