...
# Acceptance Criteria — Canon engine — _requirements/00-canonical/* generator with capped research (0.15.0 sprint 2)
...
- AC-1.1: Given {{ac_1_1_given}}, when {{ac_1_1_when}}, then {{ac_1_1_then}}.
  verified_by: tests/regression/SP-20260525-022/<test-file>.test.js::<test-name>
