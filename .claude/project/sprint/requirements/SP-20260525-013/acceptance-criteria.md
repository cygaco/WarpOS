...
# Acceptance Criteria — Events retention policy — auto-roll events.jsonl above threshold (milestone 0.13.0 sprint 4)
...
- AC-1.1: Given {{ac_1_1_given}}, when {{ac_1_1_when}}, then {{ac_1_1_then}}.
  verified_by: tests/regression/SP-20260525-013/<test-file>.test.js::<test-name>
