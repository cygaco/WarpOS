...
# Acceptance Criteria — Dispatch-shape north star — resolver + earn-it ping-reap fix + mechanical enforcement
...
- AC-1.1: Given {{ac_1_1_given}}, when {{ac_1_1_when}}, then {{ac_1_1_then}}.
  verified_by: tests/regression/SP-20260608-001/<test-file>.test.js::<test-name>
