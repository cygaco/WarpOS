...
# Acceptance Criteria — Maintainer canonical scrub orchestration (milestone 0.10.0 sprint 1)
...
- AC-1.1: Given {{ac_1_1_given}}, when {{ac_1_1_when}}, then {{ac_1_1_then}}.
  verified_by: tests/regression/SP-20260525-001/<test-file>.test.js::<test-name>
