...
# Acceptance Criteria — Migration bootstrap script — convert existing WarpOS installs to _warpos/ architecture
...
- AC-1.1: Given {{ac_1_1_given}}, when {{ac_1_1_when}}, then {{ac_1_1_then}}.
  verified_by: tests/regression/SP-20260522-004/<test-file>.test.js::<test-name>
