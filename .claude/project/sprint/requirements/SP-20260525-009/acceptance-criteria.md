...
# Acceptance Criteria — Skill-engine coherence check — /check:skill-engines + release-build gate (milestone 0.12.0 sprint 5)
...
- AC-1.1: Given {{ac_1_1_given}}, when {{ac_1_1_when}}, then {{ac_1_1_then}}.
  verified_by: tests/regression/SP-20260525-009/<test-file>.test.js::<test-name>
