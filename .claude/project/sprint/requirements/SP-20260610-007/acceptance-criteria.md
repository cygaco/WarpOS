...
# Acceptance Criteria — E-DISPATCH-SHAPE-001 W1 — make availability and fallback real
...
- AC-1.1: Given {{ac_1_1_given}}, when {{ac_1_1_when}}, then {{ac_1_1_then}}.
  verified_by: tests/regression/SP-20260610-007/<test-file>.test.js::<test-name>
