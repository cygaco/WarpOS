...
# Acceptance Criteria — Lane A — ship/install integrity fixes (2026-06-10 WARPOS.md sweep)
...
- AC-1.1: Given {{ac_1_1_given}}, when {{ac_1_1_when}}, then {{ac_1_1_then}}.
  verified_by: tests/regression/SP-20260610-001/<test-file>.test.js::<test-name>
