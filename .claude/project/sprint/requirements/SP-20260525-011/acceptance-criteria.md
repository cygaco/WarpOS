...
# Acceptance Criteria — Provider catalog hygiene — remove ghost Gemini models + add catalog-validation check + redteam default flip (milestone 0.13.0 sprint 2)
...
- AC-1.1: Given {{ac_1_1_given}}, when {{ac_1_1_when}}, then {{ac_1_1_then}}.
  verified_by: tests/regression/SP-20260525-011/<test-file>.test.js::<test-name>
