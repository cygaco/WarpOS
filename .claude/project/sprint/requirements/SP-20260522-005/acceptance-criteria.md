...
# Acceptance Criteria — /warp:update --status wires manifest validator into per-file table
...
- AC-1.1: Given {{ac_1_1_given}}, when {{ac_1_1_when}}, then {{ac_1_1_then}}.
  verified_by: tests/regression/SP-20260522-005/<test-file>.test.js::<test-name>
