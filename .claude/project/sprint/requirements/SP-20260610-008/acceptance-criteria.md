...
# Acceptance Criteria — Dreamteam verified-open guard batch — W-26 + W-14 (3 closed already-fixed)
...
- AC-1.1: Given {{ac_1_1_given}}, when {{ac_1_1_when}}, then {{ac_1_1_then}}.
  verified_by: tests/regression/SP-20260610-008/<test-file>.test.js::<test-name>
