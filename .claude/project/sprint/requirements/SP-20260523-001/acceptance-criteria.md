...
# Acceptance Criteria — Fix current.yaml#status + active-sprints.yaml status lag after /sprint:full Phase 5
...
- AC-1.1: Given {{ac_1_1_given}}, when {{ac_1_1_when}}, then {{ac_1_1_then}}.
  verified_by: tests/regression/SP-20260523-001/<test-file>.test.js::<test-name>
