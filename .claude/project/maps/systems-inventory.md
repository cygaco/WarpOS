...
| agents | Agent team + build chains | agents | count=68 |
| skills | Skills | capability | count=218 |
| hooks | Hooks | automation | count=77 |
...
| reference-docs | Reference documentation | knowledge | count=27 |
