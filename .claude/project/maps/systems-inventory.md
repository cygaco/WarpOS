...
| agents | Agent team + build chains | agents | count=53 |
| skills | Skills | capability | count=129 |
| hooks | Hooks | automation | count=57 |
...
| reference-docs | Reference documentation | knowledge | count=19 |
...
| linters | Lint suite | quality | files=5 |
