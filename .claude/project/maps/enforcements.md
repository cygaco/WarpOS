...
**68** hooks, **15** lib modules. **2** uncurated (added since last hand-curation on 2026-06-08T16:07:50.686Z).

## Coverage

- Total gaps tracked: 83
- Closed: 75
- Open: 8
- Open IDs: GAP-305, GAP-706, GAP-901, GAP-1204, GAP-1301, GAP-1304, GAP-1305, GAP-1306

## Hooks

| id | matcher | phase | mode | registered | uncurated |
|---|---|---|---|---|---|
| authorization-gate | Bash+Edit|Write | PreToolUse | fail-open | yes |  |
...
| lint-hook-output | Edit|Write | PreToolUse | advisory | yes |  |
...
| sprint-routing-guard | Edit|Write | PreToolUse | mixed | yes |  |
...
| tracker-completion-gate | (universal) | Stop | mixed | yes |  |
| tracker-start-of-work | (universal) | SessionStart | fail-open | yes |  |
| typecheck | Edit|Write | PostToolUse | mixed | yes |  |
| ui-lint | Edit|Write | PostToolUse | advisory | yes |  |
| untrusted-content-firewall | WebFetch|WebSearch|mcp__.*|ListMcpResourcesTool|ReadMcpResourceTool | PostToolUse | fail-closed | yes |  |
| version-bump-guard | Bash (git commit) | PreToolUse | mixed | yes |  |
...
| untrusted-content | scripts/hooks/lib/untrusted-content.js |  |
