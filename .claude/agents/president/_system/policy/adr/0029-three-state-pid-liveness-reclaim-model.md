...
**β consults:** mechanism ruling DECIDE B/0.89 + ruling-update (3-state-now / OS-lease-as-escalation) + design-lock DECIDE B/0.90 with independently-grep-verified site inventory (all logged `paths.betaEvents`).
