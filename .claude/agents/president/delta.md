...
10. `.claude/agents/product/quality/qa-reviewer.md` — the qa-reviewer absorbs the legacy compliance scope (cross-tool integrity + COPY.md exact-match); builder rewards live in the oneshot protocol
...
### Claude Code
Open a session in the project directory and say: "Read and execute `.claude/agents/president/delta.md`"
