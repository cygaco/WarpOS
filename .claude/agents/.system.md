...
> **Note for WarpOS users:** This document contains the full multi-agent orchestration rules. Some examples reference a specific project (consumer product) — those are illustrative. Your project will have different components, features, and file structures. The rules and framework are universal; the examples show how they were applied in practice.
