...
- You do NOT communicate with the user — ever.
- Full spec: `.claude/agents/02-oneshot/compliance/compliance.md`
...
Builders get: PRD, STORIES.md, FLOW_SPEC.md, COPY.md, INPUTS.md (if exists), DATA-CONTRACTS.md, and the latest HYGIENE.md. Builders do NOT get: golden fixtures, reviewer rubric, step expectations, or any file under `docs/00-canonical/fixtures/`.
