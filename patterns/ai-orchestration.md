...
**Used in:** source consumer product (PARSE prompt)
...
**Used in:** source consumer product (MARKET_PREP → MARKET)
...
**Used in:** source consumer product (RESUME_GEN, TARGETED, LINKEDIN prompts)
...
**Used in:** source consumer product (job descriptions from Bright Data)
...
**Used in:** source consumer product (`/api/claude` route)
