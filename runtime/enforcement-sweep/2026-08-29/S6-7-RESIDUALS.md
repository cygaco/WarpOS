...
**Entries: twelve.** Each names its recording location. This list's completeness is bounded by the derivation rule above and by nothing else; a residual that fails any of the rule's three conditions is absent from it by construction and not by judgment.
