...
4. Security lane MEDIUM — `spawn-shim.js`'s split-secret worked example is false (fail-safe direction); qa MEDIUMs — a third unnamed escape class; the NOT-bound enumeration omits P1–P4 headings (an inverted P2 heading ships green); qa LOWs as filed.
