...
- [ ] Tracker hygiene: ROADMAP § Epics + TRACKER.md reconciled (DONE 2026-06-12 — Claude audit reconciled both); every sprint id minted explicitly via add-sprint.js (RI-007) — NOT fully met: S-PF-01 was minted via add-sprint.js, but S-PF-02..S-PF-08 were executed as epic work items on the S-PF-01 branch without individual sprint mints. Held open honestly; close at epic close with either backfilled mints or an explicit RI-007 waiver.
