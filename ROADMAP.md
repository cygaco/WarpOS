...
>
> **Priority ordering (current focus first):** **E-DISPATCH-INTEGRITY-001 leads (⭐ TOP, operator-directed 2026-06-07 — kill "sprint theater" / dispatch-done-wrong at its source)**; then the `/warp:reconcile` golden-flow thrust (E-GOLDEN-FLOW-001) + content-delivery integrity (E-CONTENT-DELIVERY-001); E-TRACKER-001 is closing; the remaining theme-epics are planned; the trigger-gated bets are parked with no current commitment.

### Active epics

#### E-DISPATCH-INTEGRITY-001 — Agent Dispatch & Orchestration Integrity (+ agents-folder de-dot) — ⭐ TOP
