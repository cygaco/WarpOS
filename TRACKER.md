...
1. **E-DISPATCH-SHAPE-001 W2 core** — the wrapper enforce-flip (HIGH-BLAST; per-wrapper report-only→enforce ramp + kill-switch + planted tests + cross-provider gauntlet, per `_planning/epics/E-DISPATCH-SHAPE-001.md` §12. The W2 "fix-first" resolver-weakness prerequisite LANDED 2026-06-16 @`2662b9b0`, so this is unblocked). On the Master Console critical path (SG-C).
